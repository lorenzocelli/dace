...
class VariableProcessor:
    ...
    def get_var(self, parent: ast_internal_classes.FNode,
    ...
    def _parse_call_expr_node(self, node: ast_internal_classes.Call_Expr_Node):
        ...
        if array_node is None:
            ...
            array_node = ast_internal_classes.Array_Subscript_Node(
                ...
                parent=arg.parent,
                type='VOID',
                indices=[ast_internal_classes.ParDecl_Node(type='RANGE', range=[range_const, range_const])],
                sizes=[])
...
class MathFunctions(IntrinsicTransformation):
    MathTransformation = namedtuple("MathTransformation",
...
class FortranIntrinsics:
    ...
    def replace_function_name(self, node: Union[FASTNode,
                                                ast_internal_classes.Name_Node]) -> ast_internal_classes.Name_Node:
    ...
    def output_size(node: ast_internal_classes.Call_Expr_Node):
        ...
        if func_name in FortranIntrinsics.IMPLEMENTATIONS_AST:
            ...
            if isinstance(replacement_rule,
                          MathFunctions.MathTransformation) and replacement_rule.size_function is not None:
